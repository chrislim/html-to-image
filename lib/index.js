        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) { return function () { setTimeout(resolve, 3000); }; })];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, isSafari];
            }
        });
    });
}
